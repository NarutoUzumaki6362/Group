...
CHANNEL_USERNAME = "@spidyfeedback"
...
def handle_attack(message):
    ...
    if not is_user_in_channel(user_id):
        bot.reply_to(message, f"❗ **𝐇𝐀𝐑𝐀𝐌𝐈 𝐒𝐀𝐋𝐄 𝐅𝐑𝐄𝐄 𝐌𝐄 𝐔𝐒𝐄 𝐊𝐀𝐑𝐄𝐆𝐀**JOIN KARLO WARNA USE NHI KAR PAOGE {CHANNEL_USERNAME} 🔥")
        return
    ...
    if time_duration > 180:
        bot.reply_to(message, "🚫 **𝐏𝐀𝐆𝐋𝐀 𝐇𝐀𝐈 𝐊𝐘𝐀 180 𝐒𝐄 𝐉𝐀𝐃𝐀 𝐊𝐀 𝐀𝐓𝐓𝐀𝐂𝐊 𝐋𝐀𝐆𝐀 𝐓𝐎𝐇 𝐁𝐀𝐍 𝐊𝐀𝐑𝐃𝐔𝐍𝐆𝐀= 𝟏80𝐬!**")
        return
