...
void print_banner() {
    ...
    printf("\033[1;36m║ \033[1;32m██║  ██║██║  ██║███████╗    ██║  ██║╚██████╔╝██║ ╚████║██║  ██║║\033[0m\n");
    printf("\033[1;36m╠═══════════════════════════════════════════════════════════════════╣\033[0m\n");
    printf("\033[1;36m║ \033[1;33m✦ DEVELOPED BY: \033[1;32m@SPIDY_OWNEROP                            \033[1;36m║\033[0m\n");
    ...
    printf("\033[1;36m║ \033[1;33m✦ AAGYA TERA BAAP BY: \033[1;32m                           \033[1;36m║\033[0m\n");
    ...
    printf("\033[1;36m║ \033[1;33m✦ CONTACT: \033[1;32m@SPIDY_OWNEROP                          \033[1;36m║\033[0m\n");
    printf("\033[1;36m╠═══════════════════════════════════════════════════════════════════╣\033[0m\n");
    printf("\033[1;36m║ \033[1;32m██████╗  █████╗ ██████╗      ██╗  ██╗ ██████╗ ███╗   ██╗ ██████╗ ║\033[0m\n");
    printf("\033[1;36m║ \033[1;32m██╔══██╗██╔══██╗╚════██╗    ██║  ██║██╔═══██╗████╗  ██║██╔══██╗║\033[0m\n");
    printf("\033[1;36m║ \033[1;32m██████╔╝███████║ █████╔╝    ███████║██║   ██║██╔██╗ ██║██████╔╝║\033[0m\n");
...
void *stats_thread(void *args) {
    ...
    while (keep_running) {
        ...
        printf("\r\033[34m[SPIDY-ATTACK] Time: %.0fs | PPS: %lu (%.1fK/s) | Data: %.2fGB | Speed: %.2fMbps | Peak: %lupps\033[0m",
...
int main(int argc, char *argv[]) {
    ...
    if (tm->tm_year + 1900 > EXPIRATION_YEAR ||
        ...
        printf("\n\033[1;31m✖ Tool expired. Contact SPIDYXBEAST for new version.\033[0m\n");
        return EXIT_FAILURE;
    }
    ...
    printf("\n\033[1;36m[+] Starting SPIDY-ATTACK on %s:%d for %d seconds with %d threads\033[0m\n",
    ...
    free(global_payload);
    printf("\n\n\033[1;32m[✓] Attack completed by SPIDYXBEAST. Total packets sent: %lu (%.2fGB)\033[0m\n",
