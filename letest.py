...
CHANNEL_USERNAME = "https://t.me/spidycha7"
...
def handle_attack(message):
    ...
    if message.chat.id != int(GROUP_ID):
        bot.reply_to(message, f"🚫 𝐓𝐄𝐑𝐄 𝐁𝐀𝐀𝐏 𝐊𝐀 𝐁𝐎𝐓 𝐍𝐀𝐇𝐈 𝐇𝐀𝐈 𝐉𝐎 𝐅𝐈𝐑 𝐆𝐑𝐎𝐔𝐏 𝐌𝐄 𝐂𝐇𝐀𝐋𝐄𝐆𝐀\n🔗 𝐉𝐨𝐢𝐧 𝐍𝐨𝐖: {CHANNEL_USERNAME}")
        return

    if not is_user_in_channel(user_id):
        bot.reply_to(message, f"❗ **𝐇𝐀𝐑𝐀𝐌𝐈 𝐒𝐀𝐋𝐄 𝐅𝐑𝐄𝐄 𝐌𝐄 𝐔𝐒𝐄 𝐊𝐀𝐑𝐄𝐆𝐀** {CHANNEL_USERNAME} 🔥")
        return
    ...
    if time_duration > 120:
        bot.reply_to(message, "🚫 **𝐏𝐀𝐆𝐋𝐀 𝐇𝐀𝐈 𝐊𝐘𝐀 120 𝐒𝐄 𝐉𝐀𝐃𝐀 𝐊𝐀 𝐀𝐓𝐓𝐀𝐂𝐊 𝐋𝐀𝐆𝐀 𝐓𝐎𝐇 𝐁𝐀𝐍 𝐊𝐀𝐑𝐃𝐔𝐍𝐆𝐀= 𝟏𝟐𝟎𝐬!**")
        return
    ...
    bot.send_photo(message.chat.id, profile_pic, caption=f"👤 **User:** @{user_name} 🚀\n"
                                                        ...
                                                        f"📸 **𝗖𝗛𝗔𝗟 𝗔𝗕 𝗝𝗔𝗟𝗗𝗨 𝗦𝗘 𝗦𝗖𝗥𝗘𝗘𝗡 𝗦𝗛𝗢𝗧 𝗗𝗘 **\n"
                                                        f"⏳ **𝗣𝗥𝗢𝗚𝗥𝗘𝗦: 3.2%**")
    ...
    try:
        ...
        if user_status not in ['member', 'administrator', 'creator']:
            bot.reply_to(message, f"❌ **𝘾𝙃𝘼𝙇 𝘾𝙃𝘼𝙇 𝙋𝙃𝙀𝙇𝙀 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙅𝙊𝙄𝙉 𝙆𝘼𝙍!**\n"
                                  f"🔗 **𝐉𝐨𝐢𝐧 𝐇𝐞𝐫𝐞:** [Click Here](https://t.me/+LRw4QIYduFcwN2I9{CHANNEL_USERNAME})")
            return  
...
def welcome_start(message):
    user_name = message.from_user.first_name
    response = f"""𝘼𝙋𝙆𝘼 𝙎𝙐𝘼𝙂𝘼𝙏 𝙃𝘼𝙄 𝙃𝘼𝙈𝘼𝙍𝙀 𝙁𝙍𝙍𝙀 𝘿𝘿𝙊𝙎 𝙂𝙍𝙊𝙐𝙊 𝙈𝙀  {user_name} 🔥🌟
    
🚀 𝘿𝙐𝙉𝙄𝙔𝘼 𝙈𝙀 𝙎𝘼𝘽𝙎𝙀 𝙆𝙃𝘼𝙏𝘼𝙍𝙉𝘼𝙆𝙆 𝘿𝘿𝙊𝙎 𝘽𝙊𝙏 𝙃𝘼𝙄 𝘼𝘽 𝘼𝘼 𝙂𝘼𝙔𝙀 𝙅𝙊 𝙏𝙊𝙃 𝙐𝙎𝙍 𝘽𝙃𝙄 𝙆𝘼𝙍𝙇𝙊!  

🔗 **𝐓𝐨 𝐔𝐬𝐞 𝐓𝐡𝐢𝐬 𝐁𝐨𝐭, 𝐉𝐨𝐢𝐧 𝐍𝐨𝐰:**  
👉 [𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙂𝙧𝙤𝙪𝙥](https://t.me/+LRw4QIYduFcwN2I9) 🚀🔥"""
